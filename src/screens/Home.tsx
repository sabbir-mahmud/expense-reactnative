    ...
    <View className="flex-1 bg-black justify-center items-center">
      <View className="bg-black w-full">
        <TouchableOpacity onPress={() => handlePress()}>
          <View className="bg-green-400 p-5 rounded-sm mx-3 mt-3 items-center">
        ...
        <TouchableOpacity onPress={handlePress}>
          <View className="bg-red-400 p-5 rounded-sm mx-3 mt-3 items-center">
            <Text className="font-bold font-serif">
        ...
        <TouchableOpacity
          ...
          className="bg-blue-400 mx-3 mt-3 p-5 rounded">
